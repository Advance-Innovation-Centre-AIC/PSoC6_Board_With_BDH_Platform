...
modlibs library-manager qspi-configurator config device-configurator capsense-configurator capsense-tuner seglcd-configurator bsp-assistant config_usbdev usbdev-configurator smartio-configurator config_ezpd ez-pd-configurator :
	make -C FreeRTOS_with_BDH_Shell_-_WiFi_-_MQTT_Template $@
...
.PHONY: modlibs library-manager qspi-configurator config device-configurator capsense-configurator capsense-tuner seglcd-configurator bsp-assistant config_bt bt-configurator config_usbdev usbdev-configurator smartio-configurator config_ezpd ez-pd-configurator config_lin lin-configurator config_ml
